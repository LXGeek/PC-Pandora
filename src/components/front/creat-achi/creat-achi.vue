<template>
  <div class="creat-achi" v-loading.fullscreen.lock="fullscreenLoading">
    <el-nav></el-nav>
    <div class="content">
      ...
      <el-button @click="addPro">添加创作成果</el-button>
      <el-table
      :data="resAwards"
...
export default {
  ...
  methods: {
    addPro() {
      this.$router.push({name: 'AddCreat'});
    },
    render() {
