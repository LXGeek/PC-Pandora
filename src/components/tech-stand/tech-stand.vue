<template>
  <div class="tech-stand" v-loading.fullscreen.lock="fullscreenLoading">
    <el-nav></el-nav>
    <div class="content">
      ...
      <el-button @click="addPro">添加技术标准</el-button>
      <el-table
      :data="resAwards"
